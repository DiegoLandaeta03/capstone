      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return ListTile(
            ...
            title: Text('Friend Name ${index + 1}', style: GoogleFonts.outfit(color: Colors.white)),
            subtitle: Text('Last seen: 2 hrs ago', style: GoogleFonts.outfit(color: Colors.white38)),
